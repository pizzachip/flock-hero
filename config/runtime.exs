...
#
#     PHX_SERVER=true bin/flock_hero start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :flock_hero, FlockHeroWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :flock_hero, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :flock_hero, FlockHero.Mailer,
