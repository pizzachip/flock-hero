...
config :flock_hero, FlockHero.Repo,
  username: "postgres",
  password: "postgres",
  hostname: "localhost",
  database: "flock_hero_test#{System.get_env("MIX_TEST_PARTITION")}",
...
config :flock_hero, FlockHeroWeb.Endpoint,
  ...
  secret_key_base: "hCG2OPjYfAcx3JKJDQ+2ACTr9X1ocppYHYnIaPDOketsyMJWQdaizzOZ3QSqF0TU",
  server: false

# In test we don't send emails
config :flock_hero, FlockHero.Mailer, adapter: Swoosh.Adapters.Test
